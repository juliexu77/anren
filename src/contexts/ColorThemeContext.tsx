...
export const NEON_THEMES: NeonTheme[] = [
  ...
  },
  {
    ...
    textMuted: '90 8% 52%',
    cardBg: '110 25% 11%',
    cardBorder: '108 20% 16%',
    divider: '108 18% 14%',
    surface: '110 24% 13%',
    surfaceMuted: '108 22% 11%',
    baseHsl: '38 40% 68%',
    accentHsl: '38 40% 68%',
  ...
  },
  {
    id: 'clay-earth',
    name: 'Clay Earth',
    description: 'Deep umber, rich soil',
    bgPrimary: '25 30% 18%',
    bgSecondary: '22 28% 13%',
    accent1: '35 45% 62%',
    accent2: '20 35% 55%',
    textPrimary: '30 20% 95%',
    textSecondary: '25 15% 76%',
    textMuted: '22 10% 55%',
    cardBg: '25 25% 14%',
    cardBorder: '23 20% 20%',
    divider: '22 18% 17%',
    surface: '25 22% 16%',
    surfaceMuted: '23 20% 14%',
    baseHsl: '35 45% 62%',
    accentHsl: '35 45% 62%',
    secondaryHsl: '20 35% 55%',
    foreground: '30 20% 95%',
    foregroundSecondary: '25 15% 76%',
    foregroundMuted: '22 10% 55%',
    glowPrimary: 'rgba(150, 110, 70, 0.15)',
    glowSecondary: 'rgba(170, 140, 90, 0.1)',
    isLight: false,
  },
  {
    id: 'ink-silk',
